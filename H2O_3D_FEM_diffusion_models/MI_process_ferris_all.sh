...
cp 3D_diffusion_Kilauea_ct_ferris.py ./${x}/3D_diffusion_Kilauea_ct_ferris.py
...
mpirun -np 18 python3 3D_diffusion_Kilauea_ct_ferris.py ${x} ${file_melt} ${file_degas} ${aniso} ${nts} ${kd} ${dpdt} ${temp} # Currently being run on 18 cores
