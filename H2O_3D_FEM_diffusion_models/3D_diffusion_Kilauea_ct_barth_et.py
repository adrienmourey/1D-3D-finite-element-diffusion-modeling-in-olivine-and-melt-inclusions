...
xdmf =  XDMFFile("./{0}_output_barth_{1}_{2}.xdmf".format(f_mesh, f_dpdt, T))
xdmf2 =  XDMFFile("./{0}_output_barth_final_{1}_{2}.xdmf".format(f_mesh, f_dpdt, T))
...
df_out.to_csv("./{0}_output_barth_{1}_{2}_stats.csv".format(f_mesh, f_dpdt, T), sep=',')
