...
file_name1="olivine_13A" # Name of mesh files

temp=1210.0 #Temperature (C)
fo2=0.000887 #Oxygen fugacity in Pa
P_Pa=74000000.0 #Pressure in Pa
fo_core=0.896 #XFo content in olivine core
fo_rim=0.864 #XFo content in olivine rim
femg_core=0.268 #Fe/Mg ratio in olivine core
femg_rim=0.362 #Fe/Mg ratio in olivine rim
