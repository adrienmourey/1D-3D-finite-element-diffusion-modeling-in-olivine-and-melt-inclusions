...
#df = pd.DataFrame(index=[0], data= {'Median (days)': center, '1 sigma low (days)': low1, '1 sigma high (days)': high1, '2 sigma low (days)': low2, '2 sigma high (days)': high2, '1sigma error low (days)': xerrl, '1sigma error high (days)': xerrh})
...
while b < 2: 
    ...
    df['t_{0} Median (days)'.format(b + 1)] = center
    df['t_{0} 1sigma error low (days)'.format(b + 1)] = xerrl   
    df['t_{0} 1sigma error high (days)'.format(b + 1)] = xerrh
    df['t_{0} 1 sigma low (days)'.format(b + 1)] = low1
    df['t_{0} 1 sigma high (days)'.format(b + 1)] = high1
    df['t_{0} 2 sigma low (days)'.format(b + 1)] = low2
    df['t_{0} 2 sigma high (days)'.format(b + 1)] = high2
...
df['t_1c (days)'] = df['t_1 Median (days)'] + df['t_2 Median (days)'] #+ df['t_3 Median (days)'] + df['t_4 Median (days)']
df['t_2c (days)'] = df['t_2 Median (days)'] #+ df['t_3 Median (days)'] + df['t_4 Median (days)']

#df['t_3c (days)'] =  df['t_3 Median (days)'] + df['t_4 Median (days)']
#df['t_4c (days)'] =  df['t_4 Median (days)']
