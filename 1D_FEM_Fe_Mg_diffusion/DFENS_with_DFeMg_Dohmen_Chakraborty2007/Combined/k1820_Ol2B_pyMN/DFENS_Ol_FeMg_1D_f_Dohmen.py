...
def D(C, T_K, P_Pa, fO2_Pa, Ea, aniso):
    ...
    D_100 = (Constant(1.0/aniso))*D_001
    D_010 = (Constant(1.0/aniso))*D_001
...
def mod_diff(cube, nparams):
    ...
    t1, T1, lnfO2, P, Ea, comp0, comp1, intf1 = cube[0], cube[1], cube[2], cube[3], cube[4], cube[5], cube[6], cube[7]
...
if __name__ == "__main__":
    ...
    # filter observations based zone
...
#        Fixed = True
    ...
    parameters = ["t", "T", "lnfO2", "P", "Ea", "C0", "C1", "b1"]
    ...
    pcube[0,:] = [np.log10(obs_mpar['time_days'][0]), np.log10(obs_mpar['time_days'][1])]     # time (days)
    pcube[1,:] = [obs_mpar['T_C'][0], obs_mpar['T_C'][1]] # temperature (C)
    pcube[2,:] = [obs_mpar['lnfO2_bar'][0], obs_mpar['lnfO2_bar'][1]]     #log fo2_bars
    pcube[3,:] = [obs_mpar['P_kbar'][0], obs_mpar['P_kbar'][1]]     #P kbar
    pcube[4,:] = [201000.0, 20000.0] # Activation energy Ea
    pcube[5,:] = [obs_mpar['C0'][0], obs_mpar['C0'][1]]     # Composition zone 0
    pcube[6,:] = [obs_mpar['C1'][0], obs_mpar['C1'][1]]     # Composition zone 1
    pcube[7,:] = [obs_mpar['step_microns'][0], obs_mpar['step_microns'][1]]     # Boundary position 1
