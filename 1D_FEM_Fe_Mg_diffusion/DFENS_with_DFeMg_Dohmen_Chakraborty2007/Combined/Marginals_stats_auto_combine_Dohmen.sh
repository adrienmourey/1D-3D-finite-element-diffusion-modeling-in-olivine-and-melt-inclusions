...
rm Ol_1step_pyMN_time_stats_Dohmen.csv

touch Ol_1step_pyMN_time_stats_Dohmen.csv

rm Ol_1step_pyMN_medians_Dohmen.csv

touch Ol_1step_pyMN_medians_Dohmen.csv

rm Ol_2step_pyMN_time_stats_Dohmen.csv

touch Ol_2step_pyMN_time_stats_Dohmen.csv

rm Ol_2step_pyMN_medians_Dohmen.csv

touch Ol_2step_pyMN_medians_Dohmen.csv
...
cat ./${x}_pyMN/${x}_pyMN_stats.csv >> ./Ol_1step_pyMN_time_stats_Dohmen.csv

cat ./${x}_pyMN/${x}_pyMN_medians.csv >> ./Ol_1step_pyMN_medians_Dohmen.csv
...
cat ./${x}_pyMN/${x}_pyMN_stats.csv >> ./Ol_2step_pyMN_time_stats_Dohmen.csv

cat ./${x}_pyMN/${x}_pyMN_medians.csv >> ./Ol_2step_pyMN_medians_Dohmen.csv
